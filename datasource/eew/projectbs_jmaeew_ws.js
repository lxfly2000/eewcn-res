...
function eew_url(){return "wss://telegram-cf.projectbs.cn/jmaeewws/";}
...
function eew_postdata(){return "queryjson";}
...
function eew_onsuccess(str_response){
    ...
    var converted={
        ...
        latitude:original.hypocenter.location.lat,
        longitude:original.hypocenter.location.lng,
        depth:original.hypocenter.location.depth,
        epicenter:original.hypocenter.name,
        startAt:fmt_to_msts(original.originTime+" UTC+9"),//注意时区问题
        magnitude:original.hypocenter.magnitude,
        ttsepicenter:original.hypocenter.name
    };
    if(original.isWarn){
...
function is_eew_data(url){return url==="wss://telegram-cf.projectbs.cn/jmaeewws/";}
